...
# Supp Figure 7A - where we have CD8 TCR data
...
# Supp Figure 7B - TCR data per cluster
cd8_data = an.read_h5ad("CD8T_GEX_TCR.h5ad") # From GSE239452
...
# Supp figure 7 C,D - Where are the expanded clones?
#---------------------------------------------
cd8_data = an.read_h5ad("CD8T_GEX_TCR.h5ad") # From GSE239452
...
# Supp Figure 7E - Clonal expansion projected on a UMAP per sample
cd8_data = an.read_h5ad("CD8T_GEX_TCR.h5ad") # From GSE239452
clone_prop_umap_per_sample(cd8_data, pdf_prefix="TCR_clone_prop_umap_sample")


# Supp Figure 7F,G - percent of expanded clones per cluster - 5 categories and 2 categories
cd8_data = an.read_h5ad("CD8T_GEX_TCR.h5ad") # From GSE239452
